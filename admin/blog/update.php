    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive small">
                <form action="" method="post">
                    ...
                    <input type="text" name="name" class="form-control" value="<?=$posts['title']?>" id="title"><br><br>
                    <h4><label for="title"><a style="color:indigo" href=""></a>Name:</label></h4>
                    <input type="text" name="name" class="form-control" value="<?=$posts['text']?>" id="title"><br><br>
