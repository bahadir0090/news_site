    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <h2>Section title</h2>
            ...
            <form action="" method="post">
                <h3><label for="title"><small>Home title:</small></label></h3>
                <input type="text" class="form-control" name="title" placeholder="Title..." id="title" required=""><br><br>
                <h3><label for="text"><small>Home text:</small></label></h3>
                <input type="text" class="form-control" name="text" placeholder="Text..." id="text" required=""><br><br>
                <button type="submit" name="home-create" class="btn btn-outline-primary"><strong>Bul mag'liwmatlardi saqlaw</strong></button>
            </form>
    </main> 
  </div>
</div>
